	...
	private static function build(): array {
		return array(
			...
			'groups'            => array(
				...
				'f_artwork_photo_he' => 'ושהיצירה של הקבוצה תיבנה מהתמונה הזאת — נרות במקומות המוארים שבה',
				'f_artwork_photo_en' => 'And build the group’s artwork from this photo — candles where the picture is bright',
