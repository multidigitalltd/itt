	...
	private static function build(): array {
		return array(
			...
			'map'      => array(
				...
				'zoom_in_he' => 'להגדיל את המפה',
				'zoom_in_en' => 'Zoom in',
				'zoom_out_he' => 'להקטין את המפה',
				'zoom_out_en' => 'Zoom out',
				'hint_he'    => 'אפשר להגדיל את המפה וללחוץ על נקודת אור כדי לראות מאיפה היא.',
				'hint_en'    => 'Zoom in and tap a point of light to see where it is from.',
				'pick_count_he' => '%s נרות מהמדינה הזאת',
				'pick_count_en' => '%s candles from this country',
				'pick_one_he' => 'נר אחד מהמדינה הזאת',
				'pick_one_en' => 'One candle from this country',
			...
			'join'     => array(
				...
				'ded_group_title_he' => 'הנר שלכם נדלק',
				'ded_group_title_en' => 'Your candle is lit',
				'ded_group_sub_he'   => 'זו ההקדשה שהקבוצה נפתחה עליה, וכל נר שנדלק כאן נדלק עליה. אין מה לבחור.',
				'ded_group_sub_en'   => 'This is what the group was opened for, and every candle lit here is lit for it. There is nothing to choose.',
				'ded_cta_he'         => 'ממשיכים',
				'ded_cta_en'         => 'Continue',
				'skip_he'            => 'לדלג',
				'skip_en'            => 'Skip',
				...
				'weeks_title_he'     => 'לכמה שבתות הקבלה?',
				'weeks_title_en'     => 'For how many Shabbatot?',
				'weeks_1_he'         => 'שבת אחת',
				'weeks_1_en'         => 'One Shabbat',
				'weeks_2_he'         => 'שתי שבתות',
				'weeks_2_en'         => 'Two Shabbatot',
				'weeks_4_he'         => 'ארבע שבתות',
				'weeks_4_en'         => 'Four Shabbatot',
				'weeks_8_he'         => 'שמונה שבתות',
				'weeks_8_en'         => 'Eight Shabbatot',
				'weeks_help_he'      => 'אם תשאירו מייל, נזכיר לכם ביום חמישי שלפני כל אחת מהן. בסוף נשאל אם תרצו לקחת עוד משהו קטן.',
				'weeks_help_en'      => 'Leave an email and we will remind you on the Thursday before each one. At the end we will ask whether you would like to take on something else.',
				'mail_friend_he'     => 'שלום',
				'mail_friend_en'     => 'Hello',
				'mail_weekly_subject_he' => 'שבת מגיעה — והקבלה שלך',
				'mail_weekly_subject_en' => 'Shabbat is coming — and what you took on',
				'mail_weekly_body_he' => "%1\$s,\n\nשבת נכנסת בעוד יומיים, וזו התזכורת שביקשת לקבלה שלקחת על עצמך.\n\nמשהו קטן, פעם בשבוע. זה הכול.\n\nשבת שלום,\nאור לשבת\n%2\$s",
				'mail_weekly_body_en' => "%1\$s,\n\nShabbat comes in two days, and this is the reminder you asked for about what you took on.\n\nOne small thing, once a week. That is all.\n\nShabbat shalom,\nOr LeShabbat\n%2\$s",
				'mail_again_subject_he' => 'סיימת — רוצה לקחת עוד משהו קטן?',
				'mail_again_subject_en' => 'You finished — would you like to take on something else?',
				'mail_again_body_he' => "%1\$s,\n\nסיימת את מה שלקחת על עצמך. זה לא מובן מאליו, ואנחנו רוצים לומר תודה.\n\nאם בא לך להמשיך — אפשר לבחור עכשיו קבלה חדשה, ולהדליק עוד אור ביצירה.\n\nשבת שלום,\nאור לשבת\n%2\$s",
				'mail_again_body_en' => "%1\$s,\n\nYou finished what you took on. That is not a small thing, and we wanted to say thank you.\n\nIf you would like to carry on, you can choose something new now, and light another candle in the artwork.\n\nShabbat shalom,\nOr LeShabbat\n%2\$s",
			...
			'groups'            => array(
				...
				'f_artwork_help_he' => 'ככה תיראה היצירה כשהיא מלאה. אפשר לשנות אחר כך.',
				'f_artwork_help_en' => 'This is how the artwork looks when it is full. You can change it later.',
				'f_artwork_week_he' => 'זו של השבוע הזה',
				'f_artwork_week_en' => 'This week’s',
				'f_photo_he'       => 'תמונת קאבר לראש עמוד הקבוצה (לא חובה)',
