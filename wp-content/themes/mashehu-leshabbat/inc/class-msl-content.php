	...
	private static function build(): array {
		return array(
			...
			'campaign' => array(
				...
				'accent'      => '#FFB25C',
				/*
				 * Seven pictures, one per week, so the first seven weeks run
				 * without anyone touching the editor and the eighth comes back
				 * around to the star.
				 */
				'wall_shapes' => array(
					array( 'shape' => 'star' ),
					array( 'shape' => 'candles' ),
					array( 'shape' => 'jerusalem' ),
					array( 'shape' => 'menorah' ),
					array( 'shape' => 'israel' ),
					array( 'shape' => 'tablets' ),
					array( 'shape' => 'kiddush' ),
			...
			'screens'  => array(
				...
				'wall_hint_he'       => 'להגדיל, ואז ללחוץ על נר כדי לראות מי הדליק אותו.',
				'wall_hint_en'       => 'Zoom in, then click a candle to see who lit it.',
				'wall_hint_pan_he'   => 'אפשר לגרור כדי לנוע בתמונה, וללחוץ על נר כדי לראות מי הדליק אותו.',
				'wall_hint_pan_en'   => 'Drag to move around the picture, and click a candle to see who lit it.',
				'wall_canvas_he'     => 'קיר הנרות. חצים להזזה, ‎+‎ ו-‎−‎ להגדלה והקטנה, אנטר לבחירת נר.',
				'wall_canvas_en'     => 'The candle wall. Arrow keys to move, + and − to zoom, Enter to pick a candle.',
