		...
		return array(
			...
			'groups'   => self::section(
				...
				array(
					...
					self::bi( 'text', 'f_art_photo', 'בטופס — תווית התמונה שממנה נבנית היצירה' ),
					self::bi( 'text', 'f_art_photo_help', 'בטופס — ההסבר מתחת לתמונה של היצירה', 3 ),
					...
					self::bi( 'text', 'err_photo_flat', 'שגיאה — אין בתמונה מספיק אור וצל ליצירה' ),
