		...
		return array(
			...
			'groups'   => self::section(
				...
				array(
					...
					self::checkbox( 'auto_approve', 'קבוצה חדשה עולה לאוויר מיד', 'כבוי (מומלץ) = כל קבוצה ממתינה לאישור במסך "קבוצות", ועד שתאושר היא אינה מופיעה ברשימת הקבוצות באתר — אך מי שפתח אותה ומי שקיבל ממנו את הקישור כן רואים אותה ויכולים להצטרף. הטקסט בקבוצה נכתב בידי גולשים ומוצג תחת השם של המיזם.' ),
					self::bi( 'text', 'eyebrow', 'שורת פתיחה קטנה' ),
					self::bi( 'text', 'title', 'כותרת העמוד' ),
					self::bi( 'textarea', 'lead', 'פסקת פתיחה', 3 ),
